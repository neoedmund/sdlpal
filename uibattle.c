...
--*/ {
	...
	const BYTE rgStatusPos [ kStatusAll ] [ 2 ] = { { 35 , 19 } , // confused
		{ 0 , 0 } , // slow
		{ 54 , 1 } , // sleep
		{ 55 , 20 } , // silence
		{ 0 , 0 } , // puppet
...
--*/ {
	...
	MENUITEM rgMenuItem [ ] = {
		...
		{ 0 , BATTLEUI_LABEL_AUTO , TRUE , PAL_XY ( 16 , 32 ) } , { 1 , BATTLEUI_LABEL_INVENTORY , TRUE , PAL_XY ( 16 , 50 ) } , { 2 , BATTLEUI_LABEL_DEFEND , TRUE , PAL_XY ( 16 , 68 ) } , { 3 , BATTLEUI_LABEL_FLEE , TRUE , PAL_XY ( 16 , 86 ) } , { 4 , BATTLEUI_LABEL_STATUS , TRUE , PAL_XY ( 16 , 104 ) }
	} ;
	# else
	MENUITEM rgMenuItem [ ] = {
		// value   label                   enabled   position
		{ 0 , BATTLEUI_LABEL_ITEM , TRUE , PAL_XY ( 16 , 32 ) } , { 1 , BATTLEUI_LABEL_DEFEND , TRUE , PAL_XY ( 16 , 50 ) } , { 2 , BATTLEUI_LABEL_AUTO , TRUE , PAL_XY ( 16 , 68 ) } , { 3 , BATTLEUI_LABEL_FLEE , TRUE , PAL_XY ( 16 , 86 ) } , { 4 , BATTLEUI_LABEL_STATUS , TRUE , PAL_XY ( 16 , 104 ) }
	} ;
	# endif
...
--*/ {
	...
	MENUITEM rgMenuItem [ ] = {
		// value   label                      enabled   position
		{ 0 , BATTLEUI_LABEL_USEITEM , TRUE , PAL_XY ( 44 , 62 ) } , { 1 , BATTLEUI_LABEL_THROWITEM , TRUE , PAL_XY ( 44 , 80 ) } ,
	} ;
...
--*/ {
	...
	if ( gpGlobals -> fAutoBattle || g_Battle . UI . fAutoAttack ) {
		...
		if ( g_Battle . UI . state != kBattleUIWait ) {
			...
			//	printf ( "[d]w=%hd %d %d\n" , w , w , w == ( WORD ) -2 ) ;
			if ( w == ( WORD ) -2 ) { //kBattleActionCoopMagic
				printf ( "[d]kBattleActionCoopMagic\n" ) ;
				//	g_Battle . UI . wSelectedIndex = autoTarget ;
				//		g_Battle . UI . wActionType = kBattleActionCoopMagic ;
				{ //same code from kBattleActionCoopMagic
				...
				g_Battle . UI . wSelectedIndex = autoTarget ; // PAL_BattleSelectAutoTarget ( ) ;
			} else {
	...
	switch ( g_Battle . UI . state ) {
		...
		//
		{
			...
			} rgItems [ ] = { { SPRITENUM_BATTLEICON_ATTACK , PAL_XY ( 27 , 140 ) , kBattleUIActionAttack } , { SPRITENUM_BATTLEICON_MAGIC , PAL_XY ( 0 , 155 ) , kBattleUIActionMagic } , { SPRITENUM_BATTLEICON_COOPMAGIC , PAL_XY ( 54 , 155 ) , kBattleUIActionCoopMagic } , { SPRITENUM_BATTLEICON_MISCMENU , PAL_XY ( 27 , 170 ) , kBattleUIActionMisc }
			} ;
